...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class CameraMotionBlur : PostEffectsBase
    {
        ...
        // show how blur would look like in action ...
        public Vector3 previewScale = Vector3.one;

        // params
        public float movementScale = 0.0f;

        // ... given this movement vector
        public float rotationScale = 1.0f;

        public float maxVelocity = 8.0f;

        // maximum velocity in pixels
        public float minVelocity = 0.1f;

        // minimum velocity in pixels
        public float velocityScale = 0.375f;

        // global velocity scale
        public float softZDistance = 0.005f;

        // for z overlap check softness (reconstruction filter only)
        public int velocityDownsample = 1;

        // low resolution velocity buffer? (optimization)
